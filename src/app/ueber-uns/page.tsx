  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const botpoison = new window.Botpoison({
        publicKey: "DEIN_BOTPOISON_PUBLIC_KEY", // HIER deinen Key eintragen
      });
      ...
      const response = await fetch(
        "https://submit-form.com/DEINE_FORMSPARK_ID",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="max-w-2xl mx-auto py-16 px-4">
      ...
      >
        ...
        >
          {status === "loading" ? "Wird verarbeitet..." : "Nachricht absenden"}
        </button>
